...
const spaceshipName = prompt("Envie o nome da nave a ser enviado")
const spaceshipCaptain = prompt("Insira o nome do capitão da nave")

const correntShip = sendSpaceship(spaceshipName, spaceshipCaptain)

const speed = Number(prompt("Insira a velocidade para qual deseja acelerar"))

accelerate(speed, correntShip)
